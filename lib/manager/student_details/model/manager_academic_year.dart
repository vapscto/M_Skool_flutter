class ManagerAcademiCYearModel {
  String? type;
  List<ManagerAcademiCYearModelValues>? values;

  ManagerAcademiCYearModel({this.type, this.values});

  ManagerAcademiCYearModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <ManagerAcademiCYearModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(ManagerAcademiCYearModelValues.fromJson(v));
      });
    }
  }
...
class ManagerAcademiCYearModelValues {
  int? asmaYId;
  int? mIId;
  String? asmaYYear;
  ...
  ManagerAcademiCYearModelValues(
      {this.asmaYId,
      this.mIId,
      this.asmaYYear,
      this.asmaYFromDate,
  ...
  ManagerAcademiCYearModelValues.fromJson(Map<String, dynamic> json) {
