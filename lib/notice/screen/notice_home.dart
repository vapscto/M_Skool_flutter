  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: widget.showAppBar
          ...
          : null,
      body: FutureBuilder<List<NoticeDataModelValues>>(
          ...
          builder: (context, snapshot) {
                            ...
                            Container(
                              ...
                              child: Center(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      "${DateTime.parse(snapshot.data!.elementAt(index).intBStartDate!).day}",
                                    ...
                                    Text(
                                      shortMonth.elementAt((DateTime.parse(
                                                  snapshot.data!
                                                      .elementAt(index)
                                                      .intBStartDate!)
                                              .month) -
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          ''' ${getFormatedDate(DateTime.parse(snapshot.data!.elementAt(index).intBStartDate!))} - ${getFormatedDate(DateTime.parse(snapshot.data!.elementAt(index).intBEndDate!))} ''',
                                          style: Theme.of(context)
                                              .textTheme
                                              .labelSmall!
                                              .merge(
            ...
            return const CustomPgrWidget(
                ...
                desc: "Don't Worry we are fetching notice's from noticeboard");
          }),
    );
  }
}
