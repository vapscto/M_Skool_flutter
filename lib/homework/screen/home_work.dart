      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
                ...
                child: Obx(() {
                  return ListView.separated(
                      ...
                      return Obx(() {
                        return Container(
                          ...
                          decoration: BoxDecoration(
                              color: widget.hwCwNbController.selectedIndex
                                          .value ==
                                      index
                            ...
                            child: InkWell(
                                onTap: () async {
                                  ...
                                  await GetHomeWorkApi.instance
                                    ...
                                    endDate: widget
                                        .hwCwNbController.dateWiseModelList
                                        .elementAt(index)
                                        .date,
                                    startDate: widget
                                        .hwCwNbController.dateWiseModelList
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      widget.hwCwNbController.dateWiseModelList
                                          .elementAt(index)
                                          .day
                                          .toString(),
                    ...
                    //     .inDays,
                    itemCount: widget.hwCwNbController.dateWiseModelList.length,
            ...
            Obx(() {
              return widget
                      .hwCwNbController.isErrorHappendInHomeWorkLoading.value
                  ? const ErrWidget(err: {
