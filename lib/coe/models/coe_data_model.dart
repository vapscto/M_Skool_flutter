class CoeDataModel {
  ...
  CoeDataModel.fromJson(Map<String, dynamic> json) {
    ...
    paid = json['paid'];
    fyPId = json['fyP_Id'];
    coereportlist = json['coereportlist'] != null
        ? Coereportlist.fromJson(json['coereportlist'])
        : null;
    month = json['month'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['paid'] = paid;
    data['fyP_Id'] = fyPId;
    if (coereportlist != null) {
      data['coereportlist'] = coereportlist!.toJson();
    }
    data['month'] = month;
...
class Coereportlist {
  String? type;
  List<CoereportlistValues>? values;

  Coereportlist({this.type, this.values});

  Coereportlist.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <CoereportlistValues>[];
      json['\$values'].forEach((v) {
        values!.add(CoereportlistValues.fromJson(v));
      });
    }
  }
...
class CoereportlistValues {
  ...
  CoereportlistValues.fromJson(Map<String, dynamic> json) {
    stdupdate = json['stdupdate'];
    stuonlineexam = json['stuonlineexam'];
    mobilenumber = json['mobilenumber'];
    disabledint = json['disabledint'];
