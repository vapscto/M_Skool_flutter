...
//
//     final salarySlipModel = salarySlipModelFromJson(jsonString);

import 'dart:convert';

SalarySlipModel salarySlipModelFromJson(String str) =>
    SalarySlipModel.fromJson(json.decode(str));

String salarySlipModelToJson(SalarySlipModel data) =>
...
class Salarylist {
  ...
  String? type;
  List<SalarySlipModel>? values;

  factory Salarylist.fromJson(Map<String, dynamic> json) => Salarylist(
        type: json["\$type"],
        values: List<SalarySlipModel>.from(
            json["\$values"].map((x) => SalarySlipModel.fromJson(x))),
      );
...
class SalarySlipModel {
  ...
  SalaryEarningDlist? salaryEarningDlist;
  bool? disabledint;
  bool? blockdashboard;
  bool? disabledorg;
  ...
  factory SalarySlipModel.fromJson(Map<String, dynamic> json) =>
      SalarySlipModel(
        ...
        salarylist: json["salarylist"] == null
            ? null
            : SalaryList.fromJson(json["salarylist"]),
        salaryEarningDlist: json["salaryEarningDlist"] == null
            ? null
            : SalaryEarningDlist.fromJson(json["salaryEarningDlist"]),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "salarylist": salarylist == null ? null : salarylist!.toJson(),
        "salaryEarningDlist":
            salaryEarningDlist == null ? null : salaryEarningDlist!.toJson(),
...
class SalaryList {
  ...
  String? type;
  List<SalaryListValue>? values;

  factory SalaryList.fromJson(Map<String, dynamic> json) => SalaryList(
        type: json["\$type"],
        values: List<SalaryListValue>.from(
            json["\$values"].map((x) => SalaryListValue.fromJson(x))),
      );
...
class SalaryListValue {
  ...
  factory SalaryListValue.fromJson(Map<String, dynamic> json) =>
      SalaryListValue(
        emeRId: json["emeR_Id"],
        intBId: json["intB_Id"],
        roleid: json["roleid"],
...
class SalaryEarningDlist {
  ...
  String? type;
  List<SalaryEarningDlistValue>? values;

  factory SalaryEarningDlist.fromJson(Map<String, dynamic> json) =>
      SalaryEarningDlist(
        type: json["\$type"],
        values: List<SalaryEarningDlistValue>.from(
            json["\$values"].map((x) => SalaryEarningDlistValue.fromJson(x))),
      );
...
class SalaryEarningDlistValue {
  SalaryEarningDlistValue({
    this.emeRId,
    this.intBId,
    this.roleid,
    this.paymentNootificationStaff,
  ...
  factory SalaryEarningDlistValue.fromJson(Map<String, dynamic> json) =>
      SalaryEarningDlistValue(
        emeRId: json["emeR_Id"],
        intBId: json["intB_Id"],
        roleid: json["roleid"],
