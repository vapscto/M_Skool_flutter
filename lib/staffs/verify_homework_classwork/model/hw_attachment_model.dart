class HwAttachmentModel {
  String? type;
  List<HwAttachmentModelValues>? values;

  HwAttachmentModel({this.type, this.values});

  HwAttachmentModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <HwAttachmentModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(HwAttachmentModelValues.fromJson(v));
      });
    }
  }
...
class HwAttachmentModelValues {
  ...
  HwAttachmentModelValues.fromJson(Map<String, dynamic> json) {
    ihWId = json['ihW_Id'];
