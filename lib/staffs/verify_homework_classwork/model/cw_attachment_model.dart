class CwAttachmentModel {
  String? type;
  List<CwAttachmentModelValues>? values;

  CwAttachmentModel({this.type, this.values});

  CwAttachmentModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <CwAttachmentModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(CwAttachmentModelValues.fromJson(v));
      });
    }
  }
...
class CwAttachmentModelValues {
  ...
  CwAttachmentModelValues.fromJson(Map<String, dynamic> json) {
    icWId = json['icW_Id'];
