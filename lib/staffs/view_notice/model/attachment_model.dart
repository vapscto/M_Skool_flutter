class AttachmentModel {
  String? type;
  List<AttachmentModelValues>? values;

  AttachmentModel({this.type, this.values});

  AttachmentModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <AttachmentModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(AttachmentModelValues.fromJson(v));
      });
    }
  }
...
class AttachmentModelValues {
  ...
  AttachmentModelValues.fromJson(Map<String, dynamic> json) {
