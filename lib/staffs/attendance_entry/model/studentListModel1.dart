...
//
//     final studentListModel1 = studentListModel1FromJson(jsonString);

import 'dart:convert';

StudentListModel1 studentListModel1FromJson(String str) =>
    StudentListModel1.fromJson(json.decode(str));

String studentListModel1ToJson(StudentListModel1 data) =>
    json.encode(data.toJson());

class StudentListModel1 {
  StudentListModel1({
    this.asAId,
    this.mIId,
    this.asmaYId,
  ...
  Admissionstandarad? subjectList;
  ...
  factory StudentListModel1.fromJson(Map<String, dynamic> json) =>
      StudentListModel1(
        asAId: json["asA_Id"],
        mIId: json["mI_Id"],
        ...
        subjectList: Admissionstandarad.fromJson(json["subjectList"]),
...
class StudentListValuess {
  ...
  factory StudentListValuess.fromJson(Map<String, dynamic> json) =>
      StudentListValuess(
