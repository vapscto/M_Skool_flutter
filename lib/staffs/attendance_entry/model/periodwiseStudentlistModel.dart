...
class PeriodWiseStudentListModel {
  ...
  int? asmcLId;
  int? asmSId;
  DateTime? asAFromDate;
  int? amsTId;
  double? asAClassAttended;
  PeroidWiseStudentList? studentList;
  bool? returnval;
  String? monthflag;
  double? countclass;
  int? countclass1;
  ...
  factory PeriodWiseStudentListModel.fromJson(Map<String, dynamic> json) =>
      PeriodWiseStudentListModel(
        ...
        asmSId: json["asmS_Id"],
        asAFromDate: DateTime.parse(json["asA_FromDate"]),
        amsTId: json["amsT_Id"],
        asAClassAttended: json["asA_Class_Attended"],
        studentList: PeroidWiseStudentList.fromJson(json["studentList"]),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "asmcL_Id": asmcLId,
        "asmS_Id": asmSId,
        "asA_FromDate": asAFromDate!.toIso8601String(),
        "amsT_Id": amsTId,
...
class Admissionstandarad {
  ...
  factory Admissionstandarad.fromJson(Map<String, dynamic> json) =>
      Admissionstandarad(
        type: json["\$type"],
        values: List<AdmissionstandaradValue?>.from(
            json["\$values"].map((x) => AdmissionstandaradValue.fromJson(x))),
      );
...
class AdmissionstandaradValue {
  ...
  factory AdmissionstandaradValue.fromJson(Map<String, dynamic> json) =>
      AdmissionstandaradValue(
        ...
        asCAttSchedulerFlag: json["asC_Att_Scheduler_Flag"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "asC_Att_Scheduler_Flag": asCAttSchedulerFlag,
...
class Getstandarad {
  ...
  factory Getstandarad.fromJson(Map<String, dynamic> json) => Getstandarad(
        type: json["\$type"],
        values: List<GetstandaradValue?>.from(
...
class PeroidWiseStudentList {
  PeroidWiseStudentList({
    this.type,
    this.values,
  });
  ...
  factory PeroidWiseStudentList.fromJson(Map<String, dynamic> json) =>
      PeroidWiseStudentList(
        type: json["\$type"],
        values: List<PeroidWiseStudentListValue?>.from(json["\$values"]
